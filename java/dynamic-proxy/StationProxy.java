...
public class Test {
    ...
    private static void createProxy() throws Exception {  
        ...
        CtClass cc = pool.makeClass("com.dynamic.StationProxy");  
          
        // 设置接口
        CtClass interface1 = pool.get("com.dynamic.TicketService");  
        ...
        CtClass stationClass = pool.get("com.dynamic.Station");  
